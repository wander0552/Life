...
//        String token = PrefsUtils.loadPrefString(App.getAppContext(), "token");
//        params.put("token", token);     //param支持中文,直接传,不要自己编码
//        params.put("commonParamsKey2", "这里支持中文参数");
        //        return netPath + "relationship!queryBoxStoryByName.action?token=" + AccountManager.getUserBean().getToken() + "&currentPage=" + currentPage;
        //-----------------------------------------------------------------------------------//
